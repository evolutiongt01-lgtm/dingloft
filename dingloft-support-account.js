/* Dingloft Support · Customer realtime chat · v2.8 · Confirmed access-code handoff + edit state */
...
function inject(){
  ...
  .dl-remote-code-sent{display:grid;grid-template-columns:36px minmax(0,1fr) auto;gap:9px;align-items:center;margin-top:8px;padding:10px;border:1px solid #bcebd2;border-radius:12px;background:#effcf5;animation:dlRemoteSent .42s cubic-bezier(.16,1,.3,1) both}.dl-remote-sent-icon{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:#24a866;color:#fff;font-size:18px;animation:dlRemoteCheck .55s cubic-bezier(.2,1.4,.4,1) both}.dl-remote-code-sent b{display:block;color:#17643f;font-size:10px}.dl-remote-code-sent small{display:block;color:#56806b;font-size:7.5px;margin-top:3px;line-height:1.35}.dl-remote-code-sent button{border:1px solid #b5ddc7;border-radius:9px;background:#fff;color:#17643f;padding:7px 8px;font-size:8px;font-weight:850;cursor:pointer}@keyframes dlRemoteSent{from{opacity:0;transform:translateY(7px) scale(.97)}to{opacity:1;transform:none}}@keyframes dlRemoteCheck{0%{transform:scale(.4) rotate(-25deg);opacity:0}100%{transform:scale(1);opacity:1}}
