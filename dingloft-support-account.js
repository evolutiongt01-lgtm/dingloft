...
function inject(){
  ...
  .dl-feedback-slider{height:30px;margin:0;cursor:grab;touch-action:pan-x;user-select:none;-webkit-user-select:none;background:transparent}.dl-feedback-slider:active{cursor:grabbing}.dl-feedback-slider::-webkit-slider-runnable-track{height:8px;border-radius:99px;background:linear-gradient(90deg,#ff6f7d,#ff9a68,#ffd166,#80d9ad,#55e3aa);box-shadow:inset 0 1px 3px rgba(15,23,42,.16)}.dl-feedback-slider::-webkit-slider-thumb{margin-top:-8px;width:24px;height:24px}.dl-feedback-slider::-moz-range-track{height:8px;border:0;border-radius:99px;background:linear-gradient(90deg,#ff6f7d,#ff9a68,#ffd166,#80d9ad,#55e3aa)}.dl-feedback-slider::-moz-range-thumb{width:16px;height:16px;border-radius:50%;background:#fff;border:5px solid var(--face-accent)}
  ...
  @media(max-width:700px){
    ...
    .dl-support-root.panel-open.feedback-cinema .dl-support-backdrop{background:radial-gradient(circle at 50% 44%,color-mix(in srgb,var(--cinema-accent) 36%,transparent),transparent 60%),rgba(2,6,12,.84)!important}.dl-feedback-slider{height:46px;margin:-6px 0;touch-action:pan-x}.dl-feedback-slider::-webkit-slider-runnable-track{height:10px}.dl-feedback-slider::-webkit-slider-thumb{width:30px;height:30px;margin-top:-10px;border-width:6px}
