...
function inject(){
  ...
  @media(min-width:900px) and (pointer:fine){.dl-support-root.persistent-shell .dl-support-launch{left:24px!important;right:auto!important}.dl-support-root.persistent-shell .dl-support-panel{left:28px!important;right:auto!important;transform-origin:0 20%}}
...
async function togglePanel(open){
  ...
  if(window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches)finishClose();else supportCloseTimer=setTimeout(finishClose,mobileSupportMode()?290:280);
}
