...
(() => {
  ...
  function styleText() {
    return `
      ...
      #${HOST_ID} .dlmc-totalrow{display:flex;align-items:center;justify-content:space-between;gap:15px;margin:7px 1px;color:#dce5ec;font-size:.78rem} #${HOST_ID} .dlmc-totalrow.total{margin-top:9px;color:#fff;font-size:1rem;font-weight:800} #${HOST_ID} .dlmc-totalrow.total strong{color:#b7ff34;font-size:1.28rem}
