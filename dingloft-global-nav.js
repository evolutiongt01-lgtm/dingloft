/* Dingloft Global Navbar + Cart · v135
...
(() => {
  'use strict';
  if (window.__DINGLOFT_GLOBAL_NAV_V135__ || window.__DINGLOFT_GLOBAL_NAV_V132__ || window.__DINGLOFT_GLOBAL_NAV_V131__ || window.__DINGLOFT_GLOBAL_NAV_V130__ || window.__DINGLOFT_GLOBAL_NAV_V129__ || window.__DINGLOFT_GLOBAL_NAV_V128__ || window.__DINGLOFT_GLOBAL_NAV_V127__ || window.__DINGLOFT_GLOBAL_NAV_V126__ || window.__DINGLOFT_GLOBAL_NAV_V125__ || window.__DINGLOFT_GLOBAL_NAV_V124__) return;
  window.__DINGLOFT_GLOBAL_NAV_V135__ = true;
  ...
  // National Days v10 is owned canonically by the global public shell/navbar.
  ...
  const ensureNationalDays = () => {
    ...
    const exact = document.querySelector('script[data-dingloft-national-days="10"],script[src*="dingloft-national-days.js?v=10"]');
    if (exact) return;
    const nationalDaysScript=document.createElement('script');
    nationalDaysScript.src='/dingloft-national-days.js?v=10';
    ...
    nationalDaysScript.addEventListener('error',()=>{
      ...
      console.error('[Dingloft National Days] No se pudo cargar /dingloft-national-days.js?v=10. Verifica que el archivo esté publicado en la raíz del sitio.');
    },{once:true});
