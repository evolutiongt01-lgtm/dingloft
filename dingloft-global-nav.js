/* Dingloft Global Navbar + Cart · v132
...
(() => {
  'use strict';
  if (window.__DINGLOFT_GLOBAL_NAV_V132__ || window.__DINGLOFT_GLOBAL_NAV_V131__ || window.__DINGLOFT_GLOBAL_NAV_V130__ || window.__DINGLOFT_GLOBAL_NAV_V129__ || window.__DINGLOFT_GLOBAL_NAV_V128__ || window.__DINGLOFT_GLOBAL_NAV_V127__ || window.__DINGLOFT_GLOBAL_NAV_V126__ || window.__DINGLOFT_GLOBAL_NAV_V125__ || window.__DINGLOFT_GLOBAL_NAV_V124__) return;
  ...
  // National Days v7 is owned canonically by the global public shell/navbar.
  ...
  const ensureNationalDays = () => {
    ...
    const exact = document.querySelector('script[data-dingloft-national-days="7"],script[src*="dingloft-national-days.js?v=7"]');
    if (exact) return;
    const nationalDaysScript=document.createElement('script');
    nationalDaysScript.src='/dingloft-national-days.js?v=7';
    nationalDaysScript.dataset.dingloftNationalDays='7';
    ...
    nationalDaysScript.addEventListener('error',()=>{
      ...
      console.error('[Dingloft National Days] No se pudo cargar /dingloft-national-days.js?v=7. Verifica que el archivo esté publicado en la raíz del sitio.');
    },{once:true});
