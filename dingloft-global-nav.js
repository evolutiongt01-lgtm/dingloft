...
(() => {
  ...
  // National Days v11 is owned canonically by the global public shell/navbar.
  ...
  const ensureNationalDays = () => {
    ...
    const exact = document.querySelector('script[data-dingloft-national-days="11"],script[src*="dingloft-national-days.js?v=11"]');
    if (exact) return;
    const nationalDaysScript=document.createElement('script');
    nationalDaysScript.src='/dingloft-national-days.js?v=11';
    ...
    nationalDaysScript.addEventListener('error',()=>{
      ...
      console.error('[Dingloft National Days] No se pudo cargar /dingloft-national-days.js?v=11. Verifica que el archivo esté publicado en la raíz del sitio.');
    },{once:true});
