(() => {
  ...
  function loadGlobalSupport(){
    ...
    const script=document.createElement('script');script.type='module';script.src='/dingloft-support-account.js?v=28';script.dataset.dingloftGlobalSupport='28';document.head.appendChild(script);
  }
