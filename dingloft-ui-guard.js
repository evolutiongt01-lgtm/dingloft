(() => {
  ...
  function loadGlobalSupport(){
    ...
    const script=document.createElement('script');script.type='module';script.src='/dingloft-support-account.js?v=26';script.dataset.dingloftGlobalSupport='25';document.head.appendChild(script);
  }
